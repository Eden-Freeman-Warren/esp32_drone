#!/usr/bin/env python3
"""
Autonomous ESP32-S3 ESP-Drone hover with motor-path diagnostics.
...
def main():
    ...
    try:
        ...
        with SyncCrazyflie(
            ...
            # Protocol version 4 does not have a working supervisor
            # arming service in ESP-Drone. Force the old firmware's motor
            # gate explicitly, then log every stage of the control path.
            ...
            while time.monotonic() < hover_deadline:
                ...
                if position is None or age > TRACKING_TIMEOUT:
                    raise RuntimeError(
                        "OptiTrack stopped during flight."
                    )
