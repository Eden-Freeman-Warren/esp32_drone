...
{
    //     const uint16_t testThrust = 45000;

    // DEBUG_PRINTI("CUSTOM MOTOR POWER TEST START\n");
    // DEBUG_PRINTI("Props OFF. Testing each motor at thrust=%u\n", testThrust);
    ...
    // DEBUG_PRINTI("Testing M1 only\n");
    // motorsSetRatio(MOTOR_M1, testThrust);
    // vTaskDelay(M2T(2000));
    // motorsSetRatio(MOTOR_M1, 0);
    // vTaskDelay(M2T(1000));

    // DEBUG_PRINTI("Testing M2 only\n");
    // motorsSetRatio(MOTOR_M2, testThrust);
    // vTaskDelay(M2T(2000));
    // motorsSetRatio(MOTOR_M2, 0);
    // vTaskDelay(M2T(1000));

    // DEBUG_PRINTI("Testing M3 only\n");
    // motorsSetRatio(MOTOR_M3, testThrust);
    // vTaskDelay(M2T(2000));
    // motorsSetRatio(MOTOR_M3, 0);
    // vTaskDelay(M2T(1000));

    // DEBUG_PRINTI("Testing M4 only\n");
    // motorsSetRatio(MOTOR_M4, testThrust);
    // vTaskDelay(M2T(2000));
    // motorsSetRatio(MOTOR_M4, 0);
    // vTaskDelay(M2T(1000));

    // DEBUG_PRINTI("Testing ALL MOTORS together\n");
    // motorsSetRatio(MOTOR_M1, testThrust);
    // motorsSetRatio(MOTOR_M2, testThrust);
    // motorsSetRatio(MOTOR_M3, testThrust);
    // motorsSetRatio(MOTOR_M4, testThrust);
    ...
    // DEBUG_PRINTI("CUSTOM MOTOR POWER TEST DONE\n");
